...
const fileCancelButton = document.querySelector("#file-cancle");
...
const generateBotResponse = async(incomingMessageDiv) => {
    const meassageElement = incomingMessageDiv.querySelector(".message-text");
    ...
    try{
        ...
        meassageElement.innerText = apiResposeText;
        ...
        console.log(error);
        meassageElement.innerText = error.message;
        meassageElement.style.color = "#ff0000";
    } finally{
        userData.file = {};
...
const handleOutgoingMessage = (e) => {
    ...
    const outgoingMessageDiv = createMessageElement(messageContent , "user-meassage");
    ...
    setTimeout(() => {
        ...
        const incomingMessageDiv = createMessageElement(messageContent , "bot-meassage" , "thinking");
...
//adding enter button as a message sending keyword
